        ...
        <Section style={s.wrap}>
          ...
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            <tbody>
              ...
              {position && (
                <tr>
                  <td style={s.label}>Position</td>
                  <td style={s.value}>{position}</td>
                </tr>
              )}
              {cvFilename && (
                <tr>
                  <td style={s.label}>CV</td>
                  <td style={s.value}>{cvFilename} (attached)</td>
                </tr>
              )}
            </tbody>
          </table>
          ...
          {coverLetter && (
            <>
              ...
              <Text style={s.message}>{coverLetter}</Text>
            </>
          )}
