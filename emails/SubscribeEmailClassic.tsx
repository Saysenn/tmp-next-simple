...
const s = {
  ...
  subscriberInfo:  { paddingLeft: "16px", verticalAlign: "top" as const },
  subscriberName:  { margin: "0 0 4px", color: "#111827", fontSize: "16px", fontWeight: "600" },
  subscriberEmail: { fontSize: "14px", textDecoration: "none" },
  subscriberRole:  { margin: "4px 0 0", color: "#6b7280", fontSize: "13px" },
  detailsSection:  { backgroundColor: "#f9fafb", borderRadius: "6px", padding: "16px 20px", marginBottom: "24px", border: "1px solid #e5e7eb" },
  key:             { color: "#9ca3af", fontSize: "11px", textTransform: "uppercase" as const, letterSpacing: "0.5px", fontWeight: "600", padding: "7px 12px 7px 0", width: "90px", verticalAlign: "top" as const },
