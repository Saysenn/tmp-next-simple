      ...
      <Body style={s.body}>
        <Container style={s.container}>
          ...
          <Section style={{ ...s.header, backgroundColor: DARK }}>
            ...
            <Text style={{ ...s.headerLabel, color: ACCENT }}>New Enquiry{cvFilename ? " + CV" : ""}</Text>
          </Section>
          ...
          <Section style={s.content}>
            ...
            {/* CV notice */}
            {cvFilename && (
              <Section style={s.cvRow}>
                <Text style={{ ...s.cvBadge, color: ACCENT }}>↳ CV attached: {cvFilename}</Text>
              </Section>
            )}
...
const s = {
  ...
  card:          { backgroundColor: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: "8px", padding: "20px", marginBottom: "20px" },
  ...
  cvRow:         { marginBottom: "20px" },
  cvBadge:       { margin: "0", fontSize: "13px", fontWeight: "600" },
