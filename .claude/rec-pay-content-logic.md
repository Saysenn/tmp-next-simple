...
Industry Focus: [INSERT NICHE for example Social Work, Housing, IT, Public Sector]
Target Clients: [for example Local Authorities, Private Companies, NHS]
Candidate Types: [for example Social Workers, Support Workers, IT Developers]
Tone Preference: [for example Corporate, Friendly, Premium, Modern]
Unique Selling Points (optional): [for example Fast placements, Large talent pool, Specialist expertise]

TONE AND POSITIONING:
Use UK English spelling and tone.
Write in a professional, modern, and trustworthy style.
Keep language clear and concise.
Content should be recruitment focused around seventy to eighty percent, with workforce and payment support as a secondary element.
Strictly avoid any mention of umbrella companies, CIS, payroll bureaus, or similar terminology.

IMPORTANT:
This is a recruitment agency website, not a payroll company.
Payroll should be described lightly as workforce support, contractor management, or payment support.
